...
export const metadata:Metadata={title:"Fonia Labs | Where Ideas Become Companies",description:"Fonia Labs is a global innovation group building companies, platforms, and products that solve real-world problems."};
